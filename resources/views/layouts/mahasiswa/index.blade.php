        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Form Mahasiswa </h3>
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('') }}" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nama" name="nama" maxlength="100" placeholder="Enter your full name" required>
                      </div>
                      <div class="form-group">
                        <label for="program_studi_id_prodi">Program Study</label>
                        <select class="form-control" id="program_studi_id_prodi" name="program_studi_id_prodi" required>
                          <option value="">Select Program Study</option>
                          <?php
                          // Simulating program study data (in a real app, this would come from the database)
                          $program_studi = [
                              ['id_prodi' => 1, 'nama_prodi' => 'Teknik Informatika'],
                              ['id_prodi' => 2, 'nama_prodi' => 'Sistem Informasi'],
                              ['id_prodi' => 3, 'nama_prodi' => 'Magister Ilmu Komputer']
                          ];
